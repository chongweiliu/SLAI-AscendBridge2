> 来源：vllm-ascend docs/source/tutorials/models/Qwen3-Dense.md（main 分支，抓取于 2026-07-28）
...
- max-model-len：[4096, 5500, 20480, 40960, 135000]
- gpu-memory-utilization：['0.9', '0.90']
- 是否有量化：是（W8A8, W4A8）
- 相关环境变量：ASCEND_RT_VISIBLE_DEVICES, HCCL_BUFFSIZE, HCCL_OP_EXPANSION_MODE, IMAGE, PYTORCH_NPU_ALLOC_CONF, TASK_QUEUE_ENABLE, VLLM_USE_MODELSCOPE, VLLM_USE_V1
