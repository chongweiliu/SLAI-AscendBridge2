> 来源：vllm-ascend docs/source/tutorials/models/GLM5.2.md（main 分支，抓取于 2026-07-28）
...
- 架构类型：MoE
- 推荐 TP：[8, 16]
- DP（data-parallel-size）：[1, 2, 4]
- max-model-len：[66000, 133120, 135000, 256000, 1024000]
- gpu-memory-utilization：['0.75', '0.80', '0.90', '0.92', '0.93', '0.95']
- enforce-eager：出现（建议 Eager 模式，见原文上下文）
- 是否有量化：是（W8A8, W4A8）
- 相关环境变量：ACL_OP_INIT_MODE, ASCEND_A3_ENABLE, ASCEND_AGGREGATE_ENABLE, ASCEND_RT_VISIBLE_DEVICES, ASCEND_TRANSPORT_PRINT, CPU_AFFINITY_CONF, GLOO_SOCKET_IFNAME, HCCL_BUFFSIZE, HCCL_CONNECT_TIMEOUT, HCCL_EXEC_TIMEOUT, HCCL_IF_IP, HCCL_INTRA_ROCE_ENABLE, HCCL_OP_EXPANSION_MODE, HCCL_SOCKET_IFNAME, IMAGE, LD_LIBRARY_PATH, MOONCAKE_CONFIG_PATH, OMP_NUM_THREADS, OMP_PROC_BIND, PYTHONHASHSEED
