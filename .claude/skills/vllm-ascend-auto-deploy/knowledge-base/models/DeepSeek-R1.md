> 来源：vllm-ascend docs/source/tutorials/models/DeepSeek-R1.md（main 分支，抓取于 2026-07-28）
...
- 是否有量化：是（W8A8, W4A8, INT8）
- 相关环境变量：GLOO_SOCKET_IFNAME, HCCL_BUFFSIZE, HCCL_IF_IP, HCCL_INTRA_PCIE_ENABLE, HCCL_INTRA_ROCE_ENABLE, HCCL_OP_EXPANSION_MODE, HCCL_SOCKET_IFNAME, IMAGE, OMP_NUM_THREADS, OMP_PROC_BIND, PYTORCH_NPU_ALLOC_CONF, TP_SOCKET_IFNAME, VLLM_ASCEND_BALANCE_SCHEDULING
