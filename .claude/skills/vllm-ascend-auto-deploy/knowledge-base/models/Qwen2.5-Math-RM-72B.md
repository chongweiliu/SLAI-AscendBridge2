> 来源：vllm-ascend docs/source/tutorials/models/Qwen2.5-Math-RM-72B.md（main 分支，抓取于 2026-07-28）

# Qwen2.5-Math-RM-72B 部署知识库
...
- 相关环境变量：ASCEND_RT_VISIBLE_DEVICES, IMAGE, MODEL_PATH
