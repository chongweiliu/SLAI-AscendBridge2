> 来源：vllm-ascend docs/source/tutorials/models/Qwen3-VL-30B-A3B-Instruct.md（main 分支，抓取于 2026-07-28）

# Qwen3-VL-30B-A3B-Instruct 部署知识库
...
- 相关环境变量：HCCL_BUFFSIZE, HCCL_OP_EXPANSION_MODE, IMAGE, OMP_NUM_THREADS, OMP_PROC_BIND, PYTORCH_NPU_ALLOC_CONF, TASK_QUEUE_ENABLE, VLLM_ASCEND_ENABLE_FLASHCOMM1, VLLM_ASCEND_ENABLE_FUSED_MC2, VLLM_USE_MODELSCOPE
