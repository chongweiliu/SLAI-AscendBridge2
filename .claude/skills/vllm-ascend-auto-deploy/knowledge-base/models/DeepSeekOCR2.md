> 来源：vllm-ascend docs/source/tutorials/models/DeepSeekOCR2.md（main 分支，抓取于 2026-07-28）
...
- 相关环境变量：IMAGE, PYTORCH_NPU_ALLOC_CONF, TASK_QUEUE_ENABLE, TOKENIZERS_PARALLELISM, VLLM_ASCEND_ENABLE_NZ, VLLM_USE_V1
