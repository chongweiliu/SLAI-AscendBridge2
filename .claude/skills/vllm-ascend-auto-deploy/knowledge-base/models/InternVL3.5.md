> 来源：vllm-ascend docs/source/tutorials/models/InternVL3.5.md（main 分支，抓取于 2026-07-28）
...
- 是否有量化：是（W8A8）
- 相关环境变量：HCCL_BUFFSIZE, HCCL_OP_EXPANSION_MODE, IMAGE, OMP_NUM_THREADS, OMP_PROC_BIND, PYTORCH_NPU_ALLOC_CONF, TASK_QUEUE_ENABLE, VLLM_ASCEND_ENABLE_FLASHCOMM1, VLLM_ASCEND_ENABLE_FUSED_MC2, VLLM_TORCH_PROFILER_WITH_STACK, VLLM_USE_V1
