> 来源：vllm-ascend docs/source/tutorials/models/Qwen3-Coder-30B-A3B.md（main 分支，抓取于 2026-07-28）

# Qwen3-Coder-30B-A3B 部署知识库
...
- 是否有量化：是（W8A8）
- 相关环境变量：ASCEND_RT_VISIBLE_DEVICES, HCCL_BUFFSIZE, HCCL_OP_EXPANSION_MODE, IMAGE, OMP_NUM_THREADS, OMP_PROC_BIND, PYTORCH_NPU_ALLOC_CONF
