> 来源：vllm-ascend docs/source/tutorials/models/Qwen3.6-35B-A3B.md（main 分支，抓取于 2026-07-28）

# Qwen3.6-35B-A3B 部署知识库
...
- max-model-len：[20480, 262144]
- gpu-memory-utilization：['0.90']
- 是否有量化：是（W8A8）
- 相关环境变量：ASCEND_RT_VISIBLE_DEVICES, HCCL_BUFFSIZE, HCCL_OP_EXPANSION_MODE, IMAGE, LD_PRELOAD, OMP_NUM_THREADS, PYTORCH_NPU_ALLOC_CONF, TASK_QUEUE_ENABLE, VLLM_USE_MODELSCOPE
