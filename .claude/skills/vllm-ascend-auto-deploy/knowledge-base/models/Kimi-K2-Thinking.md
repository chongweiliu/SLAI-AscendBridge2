> 来源：vllm-ascend docs/source/tutorials/models/Kimi-K2-Thinking.md（main 分支，抓取于 2026-07-28）

# Kimi-K2-Thinking 部署知识库
...
- 是否有量化：是（存在量化配置）
- 相关环境变量：HCCL_BUFFSIZE, HCCL_OP_EXPANSION_MODE, IMAGE, INPUT_LEN, MODEL_NAME, NUM_PROMPTS, OMP_PROC_BIND, OUTPUT_LEN, PYTORCH_NPU_ALLOC_CONF, TASK_QUEUE_ENABLE, VLLM_TARGET_DEVICE
