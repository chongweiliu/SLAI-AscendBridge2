> 来源：vllm-ascend docs/source/tutorials/models/Qwen3-Omni-30B-A3B-Thinking.md（main 分支，抓取于 2026-07-28）

# Qwen3-Omni-30B-A3B-Thinking 部署知识库

## 关键信息速览（中文提炼）

- 架构类型：Omni (多模态)
- 推荐 TP：[1, 2, 4]
- max-model-len：[37364, 40960, 131072]
- gpu-memory-utilization：['0.95']
- 是否有量化：是（W8A8）
- 相关环境变量：ASCEND_RT_VISIBLE_DEVICES, HCCL_BUFFSIZE, HCCL_OP_EXPANSION_MODE, IMAGE, MODEL, OMP_NUM_THREADS, OMP_PROC_BIND, PYTORCH_NPU_ALLOC_CONF, VLLM_USE_MODELSCOPE
