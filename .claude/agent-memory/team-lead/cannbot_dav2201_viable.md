...
**Why**：v1 适配（microsoft/TRELLIS-image-large）记忆里写"cannbot BLOCKED by hardware: Ascend910=DAV_1001 (first-gen) 不在支持矩阵"。那是**旧机器**。本机换成了 dav-2201，cannbot 已可用。用户最初说"本机是 A3"是对的。
...
- 相关：[[trellis-npu-port]] 的 cannbot 段落已过时，以本条为准
