"""
Ascend NPU adaptation demo for distilbert/distilbert-base-uncased (masked LM).
...
# ============================================================
def main():
    parser = argparse.ArgumentParser(description="DistilBERT Masked-LM Ascend Adaptation Demo")
    ...
    print(f"[Run] Top-5 predictions for [MASK]: {top5_tokens}")
