"""
NPU Optimized accuracy_run_perf.py for Qwen/Qwen3-0.6B (Causal LM).
...
def main():
    parser = argparse.ArgumentParser(description="NPU optimized accuracy_run_perf.py for Qwen3-0.6B")
